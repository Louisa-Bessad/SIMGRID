...
\item syscall\_process.c gère les AS à leur entrée et à leur sortie:
  ...
  \item syscall\_open done devrait être en premier, il gère comme il faut les descripteurs (l'émulation / simulation)
  \item syscall\_close done
  \item syscall\_poll\_pre revoir
  \item syscall\_poll\_post done
  \item syscall\_inside
  \item syscall\_pipe\_post
  \item syscall\_select\_pre
  \item syscall\_proc\_outside
  \item syscall\_proc\_inside
  \item syscall\_dup2\_post
  \item syscall\_socket 
  \item syscall\_connect\_pre
  \item syscall\_connect\_post
  ...
  \item \textit{process\_connect\_in\_call}
