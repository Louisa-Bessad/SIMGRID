...
*** Planned work
*** DONE Faire des .h pour chaque fichier
- Clean all the include .h in every .h because there are loops in there
*** TODO fix 'make *** [diff-send] Erreur 1'
*** TODO fix the compilation problem of communication.o sockets.o and simterpose.o, there are linked
