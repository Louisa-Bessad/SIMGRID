...
- Mediation par translation
  ...
  - Open, close, lseek, fcntl, read and write syscalls ok
    Read and write already written
- Full mediation 
  - Read and write syscalls
*** Blocking points
*** Planned work
- Use the "time" command to get execution time
- Possible bench overhead made by simterpose to catch syscalls
  - on big and little files simple reading/write, lseek...
