...
## Ajout de bibou
set title "Temps d'exécution lors de l'envoi d'un million de messages de 128o \n en fonction du type d'exécution"
...
set output "little.png"
## Fin de l'ajout de bibou
set grid ytics

plot 'graph1_little.dat' using 2:3:4:xticlabels(1) title columnheader
