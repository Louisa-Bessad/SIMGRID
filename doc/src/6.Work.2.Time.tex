...
\lstset{escapechar=@,style=customc, caption=[Fontion \texttt{time} et appel à \texttt{tuxcall} côté processus ``espionné''{\color{white}blablablablablablabla}]{Fontion \texttt{time} et appel à \texttt{tuxcall} côté processus ``espionné''}, label=ALGO_TIME, captionpos=b}
\begin{lstlisting}
...
\lstset{escapechar=@,style=customc, caption=[Handler pour l'appel système \texttt{tuxcall} côté processus ``espion''{\color{white}blablablablablabla}]{Handler pour l'appel système \texttt{tuxcall} côté processus ``espion''}, label=ALGO_TUXCALL, captionpos=b}
\begin{lstlisting}
