...
\input{src/2.Emulation.3.Ccl.tex}

\newpage
\input{src/3.TOOLS.tex}
\input{src/3.TOOLS.1.Source.tex}
\input{src/3.TOOLS.2.Binaire.tex}
\input{src/3.TOOLS.3.AS.tex}
\input{src/3.TOOLS.4.Fonctions.tex}
\input{src/3.TOOLS.5.Ccl.tex}

\newpage
\input{src/4.SOTA.tex}
\input{src/4.SOTA.1.cwrap.tex}
\input{src/4.SOTA.2.RR.tex}
\input{src/4.SOTA.3.Distem.tex}
\input{src/4.SOTA.4.MicroGrid.tex}
\input{src/4.SOTA.5.DETER.tex}
%% \input{src/3.SOTA.6.Robot.tex}

\newpage
\input{src/5.Simterpose.tex}
\input{src/5.Simterpose.1.Orga.tex}
\input{src/5.Simterpose.2.Res.tex}
\input{src/5.Simterpose.3.Thread.tex}
\input{src/5.Simterpose.4.Time.tex}
\input{src/5.Simterpose.5.DNS.tex}
\input{src/5.Simterpose.6.Ccl.tex}

\newpage
\input{src/6.Work.tex}
\input{src/6.Work.1.Network.tex}
\input{src/6.Work.2.Time.tex}
\input{src/6.Work.3.Tools.tex}
\input{src/6.Work.4.Ccl.tex}

\newpage
\input{src/7.Evaluation.tex}
\input{src/7.Evaluation.1.Res.tex}
\input{src/7.Evaluation.2.Temps.tex}
\input{src/7.Evaluation.3.Ccl.tex}

\newpage
\input{src/8.FutureWork.tex}
\input{src/8.FutureWork.1.Simterpose.tex}
\input{src/8.FutureWork.2.Evaluation.tex}

\newpage
\input{src/9.Conclusion.tex}
