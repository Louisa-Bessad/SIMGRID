\subsection{Foctionnement interne de Simterpose}
...
pas encore été évalué en pratique.
...
\paragraph{Traduction d'adresse.}
 Avec ce type de médiation, illustrée Figure \ref{ADDRESS_TRANSLATION}, on laisse le noyau gèrre les communications. Ainsi en entrée et sortie d'appel système
 ...
 ports virtuels pour que l'application pense toujours être dans un
