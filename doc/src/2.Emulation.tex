...
d'analyse dynamique Valgrind \citep{INTERCEPTION:Valgrind,
  INTERCEPTION:Valgrindweb} que nous allons étudier. À l'origine il est utilisé
...
l'étude faite par M. Guthmuller lors de son stage \citep{INTERCEPTION:MARION}:
...
Seccomp \citet{INTERCEPTION:seccompbpf} est un appel système qui permet d'isoler
