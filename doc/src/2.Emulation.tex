...
\begin{figure}[H]
  \centering %\begin{minipage}[b]{.46\linewidth}
  \begin{subfigure}{0.3\textwidth}
  %\centering
    \includegraphics[scale=0.35]{Pictures/png/Virtualisation_limitation}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    %\end{minipage} \hfill \begin{minipage}[b]{.46\linewidth} \centering
  %\includegraphics[scale=0.3]{Pictures/png/Virtualisation_interception} \end{minipage}
  \end{subfigure}
...
\textit{Lorsqu'un point d'arrêt est atteint Uprobes prend la main et exécute le bon
...
\centering
  \begin{tabular}{c|c|c|c|c|c|}
    \cline{2-6} & ptrace & Uprobes & seccomp/BPF & LD\_PRELOAD & Got Injection
    \\ \hline
