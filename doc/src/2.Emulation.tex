...
%%   \centering\epsfig{figure=Pictures/png/Virtualisation_limitation, scale=0.25}
%%   \caption{Virtualisation standard \label{V_LIMITATION}}
%%  \end{minipage} \hfill
%%  \begin{minipage}[b]{.46\linewidth}
%%   \centering\epsfig{figure=Pictures/png/Virtualisation_interception, scale=0.22}
%%   \caption{Virtualisation par interception \label{V_INTERCEPTION}}
%%  \end{minipage}
%% \end{figure}
...
Dans notre cas, on pourrait l'utiliser pour mesurer le temps passé à faire un
...
%% coeur = uprobe_register(exec file, offset de placement du probe depuis le début du fic, struct contenant handler et filtre qui est optionnel permet de dire que faire a chaque touche differente du meme point) permet de trier les processus puisque exectubla et plus pid en param
%% une version sans utrace (roland's tracehooks) et unee avec utrace pour gérer les points d'arrêt \textit{This file defines hook entry points called by core code where
%%  11  * user tracing/debugging support might need to do something. }
...
\textit{Cependant, on peut voir que LD\_PRELOAD résout les lacunes de ptrace
...
\cline{2-5}
                                                                                       & Source to Source & \begin{tabular}[c]{@{}c@{}}Réimpplémentation \\ SMPI\end{tabular} & Coccinelle & Valgrind  \\ \hline
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Niveau \\ d'interception\end{tabular}} & Source           & Source                                                            & Source     & Binaire   \\ \hline
\multicolumn{1}{|c|}{Coût}                                                             & ?                & ?                                                                 & ?          & Important \\ \hline
\multicolumn{1}{|c|}{Utilisation}                                                      & ?                & ?                                                                 & ?          & Complèxe  \\ \hline
\end{tabular}
  \caption{Comparaison des différentes solutions d'interception au niveau de l'application}
...
\centering
  \begin{tabular}{c|c|c|c|c|c|}
    ...
    \multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Niveau\\ d'interception\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Appel\\ Système\end{tabular}   & \begin{tabular}[c]{@{}c@{}}Appel \\ Système\end{tabular} & \begin{tabular}[c]{@{}c@{}}Appel \\ Système\end{tabular} & Bibliothèque & Bibliothèque  \\ \hline
          \multicolumn{1}{|c|}{Coût}                                                            & Moyen                                                     & Faible(?)                                                & ?                                                        & Faible       & ?             \\ \hline
          \multicolumn{1}{|c|}{Utilisation}                                                     & \begin{tabular}[c]{@{}c@{}}Assez \\ complèxe\end{tabular} & ?                                                        & ?                                                        & Simple       & ?             \\ \hline
  \end{tabular}
