...
%% l'application, ainsi nous sommes sûrs d'intercepter tous les types de
...
%% informations nécessaires avant de lui rendre la main pour entrer ou sortir de
%% l'appel système.
...
%% modules dont il faudra également gérer le bon chargement. Malgré ses défauts
...
%% Pour intercepter les éventuels appels systèmes d'une application nous allons
%% donc utiliser l'appel système \textbf{ptrace}{\color{red}citation}. Il permet de
%% contrôler l'exécution de processus mais également d'écrire et de lire
...
%% souhaite être contrôlé via un appel système ptrace. À la réception de cet appel
...
%% {\color{red} Mettre un schéma attachement attente père attrape signal modification main fils as retour père...}
