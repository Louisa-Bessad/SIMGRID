% Tree of the links between the different structures of Simterpose
...
\begin{forest}
  ...
  [A\\B, phantom, calign with current
    [A\\a, inner color=col1in, outer color=col1out
      [B\\b, inner color=col2in, outer color=col2out
        [C\\c, inner color=col4in, outer color=col4out]
        [C\\c, inner color=col4in, outer color=col4out]
      ]
      [B\\b, inner color=col3in, outer color=col3out
        [C
          [\textbf{Port\_desc}\\bind\_socket\\ \textit{struct info\_socket}, rect, name=sse4
          ]
        ]
        [C
