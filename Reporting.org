...
--> 4 choses: COMM (temps de communication), SEB
...
*** TODO Mettre les en-têtes de fichiers et commentaire en en, corriger le code si besoin (erreur ctrl C/V et commentaires)
...
simulateur avant la sortie de l'AS (write ce qui n'est pas le cas du
read)
...
- pourquoi à l'entrée du connect on appel process_handle
*** Planned work
